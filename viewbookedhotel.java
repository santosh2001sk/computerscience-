...
public class viewbookedhotel extends JFrame implements ActionListener {
	JLabel ls1,ls2,ls3,ls4,ls5,ls6,ls7,ls8,ls9,ls10;
	JButton b1;
	viewbookedhotel(String Username){
		setBounds(250,30,1000,640);
		setLayout(null);
        ...
        Image i3 = i1.getImage().getScaledInstance(580, 640,Image.SCALE_DEFAULT);
        ImageIcon i2 = new ImageIcon(i3);
        JLabel l9 = new JLabel(i2);
        l9.setBounds(405,0,580,640);
        add(l9);
		...
		ls8 = new JLabel("");
		ls8.setFont(new Font("tahoma", Font.PLAIN, 20));
		ls8.setForeground(Color.blue);
		ls8.setBounds(200, 420, 200, 30);
		add(ls8);
		
		JLabel l11 = new JLabel("PHONE:");
		l11.setFont(new Font("tahoma", Font.PLAIN, 20));
		l11.setBounds(30, 470, 150, 30);
		add(l11);
		
		ls9 = new JLabel("");
		ls9.setFont(new Font("tahoma", Font.PLAIN, 20));
		ls9.setForeground(Color.blue);
		ls9.setBounds(200, 470, 200, 30);
		add(ls9);
		
		JLabel l12 = new JLabel("TOTAL PRICE:");
		l12.setFont(new Font("tahoma", Font.PLAIN, 20));
		l12.setBounds(30, 520, 150, 30);
		add(l12);
		
		ls10 = new JLabel("");
		ls10.setFont(new Font("tahoma", Font.PLAIN, 20));
		ls10.setForeground(Color.blue);
		ls10.setBounds(200, 520, 200, 30);
		add(ls10);
		...
		try {
			...
			while(rs.next()) {
				ls1.setText(rs.getString(1));
				ls2.setText(rs.getString(2));
				ls3.setText(rs.getString(3));
				ls4.setText(rs.getString(4));
				ls5.setText(rs.getString(5));
				ls6.setText(rs.getString(6));
				ls7.setText(rs.getString(7));
				ls8.setText(rs.getString(8));
				ls9.setText(rs.getString(9));
				ls10.setText(rs.getString(10));
				}
		}catch(Exception e) {}
